...
<body>
    ...
    if(isset($_GET['MaLoai']))
    {
        ...
        include("config.php");
        $loaihang = $_GET['MaLoai'];
        $sql = "select * from sach where MaLoai = '$loaihang'";
        $qr_loaihang = mysqli_query($conn, $sql);
        while($row_theoloai = mysqli_fetch_array($qr_loaihang)){
            //echo $row_theoloai['tenmh'];
                    ...
                    <div class="header-shopping-with-search">
                        ...
                        <div class="header-shopping__search">
                            <div class="header-shopping__search-input-wrap">
                                <form action="" method = "get" class="header-shopping__search-input">
                    ...
                    <div class="grid__row app__content">
                                ...
                                ?>
                                    ...
                                    <?php
                                        if(isset($_GET['MaSach']))
                                            ...
                                            $row_mathang = mysqli_fetch_array($qr_mathang);       
                                            while($row_mathang = mysqli_fetch_array($qr_mathang)){

                                    ?> 

                                        <li class="category-item">
                                            <a  href="book_details.php?MaSach=<?php echo $row_sp['MaSach'];?>"></a>
                                        </li>
                        ...
                        <div class="grid__column-10">
                            <div class="home-product">
                                <div class="grid__row">
                                    <?php
                                        $sqp_cat_home = mysqli_query($conn, "select * from sach");
                                        while ($row_cate_home = mysqli_fetch_array($sqp_cat_home)){
                                            $id_category = $row_cate_home['MaSach'];
                                    ?>

                                    <?php
                                        $sqp_sp = mysqli_query($conn, "select * from sach where MaLoai = '$loaihang'");
                                        ...
                                        <a class="home-product-item" href="book_details.php?MaSach=<?php echo $row_sp['MaSach'];?>&TenSach=<?php echo $row_sp['TenSach'];?>">
                                            ...
                                            <div class="home-product-item">
                                                ...
                                                <div class="home-product-item__origin">
                                                    <p class="home-product-item__origin-name"><b>Tác giả:</b> <?php echo $row_sp['TacGia'] ?></p>
                                                    <span class="home-product-item__brand"><b>Nhà xuất bản: </b><?php echo $row_sp['NhaXB'] ?></span>
                                                </div>
                                            </div>
