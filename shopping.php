                ...
                <div class="header-shopping-with-search">
                    ...
                    <div class="header-shopping__cart">
                        <div class="header-shopping__card-wrap">
                            <a class = "cart-icon-link" href="viewcart.php"><i class="header-shopping__cart-icon fa-sharp fa-solid fa-cart-shopping" ></i></a>
                    ...
                    <div class="rid__column-2">
                        <nav class="category">
                            ...
                            <ul class="category-list">
                                ...
                                <li class="category-item">
                                    <a  href="book_details.php?MaSach=<?php echo $row_sp['MaSach'];?>&TenSach=<?php echo $row_danhmuc['TenSach'];?>" class="category-item__link"></a>
                                </li>
                                    ...
                                    <a class="home-product-item" href="book_details.php?MaSach=<?php echo $row_sp['MaSach'];?>&TenSach=<?php echo $row_sp['TenSach'];?>">
                                        <div class="home-product-item">
                                            ...
                                            <div class="home-product-item__price">
                                                ...
                                                <!-- <span class="home-product-item__price-current"><?php echo $row_sp['giamgia'] ?></span> -->
                                            </div>
                                            ...
                                            <div class="home-product-item__action">
                                                ...
                                                <!-- <span class="home-product-item__sold"><?php echo $row_sp['daban'] ?> đã bán</span> -->
                                            </div>
